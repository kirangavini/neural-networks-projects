% Training Digital sensor BSIF features with Sagem Sensor Test dataset

%Training data
trainBSIF=[Train_All_Data_DigiBSIF(:,1:916 )  Train_All_Data_DigiBSIF(:,1016:1916 )]*10^8;
%Labelling Training data
trainlabelBSIF=[Train_All_Label_DigiBSIF(:,1:916) Train_All_Label_DigiBSIF(:,1016:1916) ];
%Seperating Validation data from training data
validationBSIF=[Train_All_Data_DigiBSIF(:,916:1016)]*10^8;
%Creating validation label
validationlabel=[Train_All_Label_DigiBSIF(:,916:1016)];
%Test data 
testBSIF=[Test_All_Data_SageBSIF Train_All_Data_SageBSIF(:,1916:2016)]*10^8;
%Labelling test data
testlabelBSIF=[Test_All_Label_SageBSIF Train_All_Label_SageBSIF(:,1916:2016)];
