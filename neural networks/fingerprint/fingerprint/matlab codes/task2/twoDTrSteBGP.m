% Training Digital sensor BGP features with Sagem Sensor Test dataset

%Training data
trainBGP=[Train_All_Data_DigiBGP(:,1:916 )  Train_All_Data_DigiBGP(:,1016:1916 )]*10^8;
%Labelling Training data
trainlabelBGP=[Train_All_Label_DigiBGP(:,1:916) Train_All_Label_DigiBGP(:,1016:1916) ];
%Seperating Validation data from training data
validationBGP=[Train_All_Data_DigiBGP(:,916:1016)]*10^8;
%Creating validation label
validationlabel=[Train_All_Label_DigiBGP(:,916:1016)];
%Test data 
testBGP=[Test_All_Data_SageBGP Train_All_Data_SageBGP(:,1916:2016)]*10^8;
%Labelling test data
testlabelBGP=[Test_All_Label_SageBGP Train_All_Label_SageBGP(:,1916:2016)];
