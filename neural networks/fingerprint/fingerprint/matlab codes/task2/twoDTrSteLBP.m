% Training Digital sensor LBP features with Sagem Test dataset

%Training data
trainLBP=[Train_All_Data_DigiLBP(:,1:916 )  Train_All_Data_DigiLBP(:,1016:1916 )];
%Labelling Training data
trainlabelLBP=[Train_All_Label_DigiLBP(:,1:916) Train_All_Label_DigiLBP(:,1016:1916) ];
%Seperating Validation data from training data
validationLBP=[Train_All_Data_DigiLBP(:,916:1016)];
%Creating validation label
validationlabel=[Train_All_Label_DigiLBP(:,916:1016)];
%Test data 
