% Training Sage sensor LBP features with Digital sensor Test dataset
...
%Test data 
testLBP=[Test_All_Data_DigiLBP Train_All_Data_DigiLBP(:,1916:2016)];
%Labelling test data
testlabelLBP=[Test_All_Label_DigiLBP Train_All_Label_DigiBSIF(:,1916:2016)];
