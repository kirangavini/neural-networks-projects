...
fold1=[c1,c2,t1,t2,r1,r2,d1,d2];
fold2=[c1,c3,t1,t3,r1,r3,d1,d3];
fold3=[c2,c3,t2,t3,r2,r3,d2,d3];
test1=[c3,t3,r3,d3];
test2=[c2,t2,r2,d2];
test3=[c1,t1,r1,d1];
H1=foldtdnn(fold1,test1);
H2=foldtdnn(fold2,test2);
H3=foldtdnn(fold3,test3);
