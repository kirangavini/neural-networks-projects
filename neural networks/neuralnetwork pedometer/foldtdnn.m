function H1=foldtdnn(data,datatest)

% Create ones and negatives for 2400 data points
testc=num2cell([ones(1,600),-1*ones(1,1800)]);
testt=num2cell([-1*ones(1,600),ones(1,600),-1*ones(1,1200)]);
testr=num2cell([-1*ones(1,1200),ones(1,600),-1*ones(1,600)]);
testd=num2cell([-1*ones(1,1800),ones(1,600)]);
